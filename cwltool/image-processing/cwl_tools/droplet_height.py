...
imageio.v2.imwrite("droplet_height_" + output_image, im, "jpg")
#imageio.v2.imwrite(output_value, np.fromstring(str(height), np.int8), "txt")

output_value_file = open("droplet_height_" + output_image + "_result.txt", "w")
